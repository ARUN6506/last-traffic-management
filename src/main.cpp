...
int main(int argc, char** argv) {
    std::string videoPath = (argc > 1 ? argv[1] : "input.mp4");
    ...
    VehicleDetector vdet("models/yolo5s.onnx", "models/classes.txt");
    HelmetDetector hdet("pyton_scripts/helmet_detector.py");
